...
<table width="103%" border="0" cellspacing="1">
  <tr>
    <th colspan="7" scope="col" align="left"><div align="center" class="style1">Japan Menu</div></th>
  </tr>
  ...
  <?php
   include "koneksi.php";
   $tampil = mysql_query("select * from product where kategori='japan'order by id desc limit $posisi,$batas") or die("Gagal :".mysql_error());
...
<?php
  echo"<br>Prev :";
$tampil2="select*from product where kategori='japan'";
...
if($i !=$halaman)
{
echo"<a href=?module=japan&halaman=$i>$i</a>|";
}
else
{
echo"<b>$i</b>|";
